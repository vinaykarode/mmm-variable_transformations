...
with tab3:
    ...
    # Params for Line A
    shape_parameter_A = st.slider(':triangular_ruler: :blue[Shape of Line A] :large_blue_square:', 0.0, 10.0, 2.0)
    scale_parameter_A = st.slider(':blue[Scale of Line A] :large_blue_square:', 0.0, 1.0, 0.5)
    # Params for Line B
    shape_parameter_B = st.slider(':triangular_ruler: :red[Shape of Line B] :large_red_square:', 0.0, 10.0, 0.5)
    scale_parameter_B = st.slider(':red[Scale of Line B] :large_red_square:', 0.0, 1.0, 0.01)
